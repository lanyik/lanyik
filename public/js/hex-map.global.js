...
`;
  ...
  function validateHexMapOptions(options) {
    ...
    positive3("size", options.size);
    positive3("terrainTextureRegionSize", options.terrainTextureRegionSize);
    positive3("renderDistance", options.renderDistance);
    ...
    positive3("maxPixelRatio", options.maxPixelRatio);
    ...
    positive3("worldSessionDrainTimeoutMs", options.worldSessionDrainTimeoutMs);
    nonNegativeSafeInteger("treesPerTile", options.treesPerTile);
    nonNegativeSafeInteger("grassDensity", options.grassDensity);
    positive3("grassBladeWidth", options.grassBladeWidth);
    positive3("grassBladeHeight", options.grassBladeHeight);
  ...
  var AdaptiveStreamingController = class {
    ...
    validate() {
      ...
      positive3("targetFrameMs", this.targetFrameMs);
      positive3("baseFrameBudgetMs", this.options.baseFrameBudgetMs);
