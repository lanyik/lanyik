...
export const DEFAULT_MESSAGES = Object.freeze({
    en: Object.freeze({
        ...
        "performance.fps": "Actual frame rate",
        "performance.theoreticalFps": "Theoretical frame rate",
        "performance.theoreticalFps.cpu": "CPU frame-rate ceiling",
        "performance.theoreticalFps.gpu": "GPU frame-rate ceiling",
        "performance.workFrameMs": "Frame work",
        "performance.cpuFrameMs": "CPU frame work",
        "performance.gpuFrameMs": "GPU render time",
        "performance.timing.cpuGpu": "500 ms averages: frame work = max(CPU, GPU); theoretical FPS = 1000 / frame work. An estimate excluding display cadence, not a measured uncapped frame rate.",
        "performance.timing.cpu": "Only CPU timing is available in this window. This is the CPU throughput ceiling; GPU work is unknown.",
        "performance.timing.gpu": "Only GPU timing is available in this window. This is the GPU throughput ceiling; CPU work is unknown.",
        "performance.timing.unavailable": "No frame-work measurements are available in this window.",
        ...
        "control.riverLength": "river length (base %)",
        ...
        "control.foam": "foam",
        "control.trees": "Tree density",
        "control.treeScale": "Tree size",
        "control.grass": "grass",
        "control.wind": "wind",
    ...
    "zh-CN": Object.freeze({
        ...
        "performance.fps": "实际帧率",
        "performance.theoreticalFps": "理论帧率",
        "performance.theoreticalFps.cpu": "理论帧率（仅 CPU）",
        "performance.theoreticalFps.gpu": "理论帧率（仅 GPU）",
        "performance.workFrameMs": "单帧工作耗时",
        "performance.cpuFrameMs": "CPU 帧耗时",
        "performance.gpuFrameMs": "GPU 渲染耗时",
        "performance.timing.cpuGpu": "按 500 毫秒窗口取均值：工作耗时 = max(CPU, GPU)，理论帧率 = 1000 / 工作耗时。这是不含屏幕刷新间隔的估算，并非解除锁帧后的实测帧率。",
        "performance.timing.cpu": "本窗口只有 CPU 耗时样本，显示 CPU 吞吐上限，GPU 耗时未知。",
        "performance.timing.gpu": "本窗口只有 GPU 耗时样本，显示 GPU 吞吐上限，CPU 耗时未知。",
        "performance.timing.unavailable": "本窗口暂无有效的帧工作耗时样本。",
