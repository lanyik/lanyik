...
export const DEFAULT_MESSAGES = Object.freeze({
    en: Object.freeze({
        ...
        "minimap.expandedHint": "Wheel: zoom · Click: target · T: teleport · M/Esc: close",
        "minimap.label": "World overview; press M or click to expand",
        "minimap.expandedLabel": "Expanded world overview; wheel to zoom, click a target, then press T to teleport",
    ...
    "zh-CN": Object.freeze({
        "minimap.title": "世界概览",
        "minimap.hint": "M：展开地图",
        "minimap.expandedHint": "滚轮：缩放 · 点击：选点 · T：传送 · M/Esc：关闭",
        "minimap.label": "世界概览；按 M 或点击展开",
        "minimap.expandedLabel": "展开的世界概览；滚轮缩放，点击目标后按 T 传送",
        "minimap.loading": "生成中…",
