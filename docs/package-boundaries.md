...
| `three-hex-map/infinite-water-curve-field` | Deterministic curve/polyline and carved-basin queries shared by generator v11 and the browser visual inspector |
