...
| World-style generation v1 | Generator v10; multi-cell ribbons and carved sea basins classify cross-chunk hex water terrain | [world-style-generation-v1.md](./world-style-generation-v1.md) |
| Infinite water curve field | Shared production/inspection curve and bounded-basin geometry | [infinite-water-curve-prototype.md](./infinite-water-curve-prototype.md) |
