...
- [Energy and production](./game/energy-and-production.md): solar generation,
  relay topology, device-owned battery joules, day/night, load priorities,
  refining batches, material ownership and actual storage construction.
