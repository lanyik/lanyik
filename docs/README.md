...
| Emberwake game | Playable airship expedition on the infinite world, with a complete objective, upgrades, ending and per-action saves | [emberwake.md](./emberwake.md) |
...
- [Emberwake / 余烬航线](./emberwake.md): playable application, expedition rules,
  deterministic sites, owned presentation and recoverable action checkpoints.
