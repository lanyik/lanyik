...
| Infinite water curve prototype | Isolated unbounded world-space curve and sampled-tributary scene; not integrated into generator v6 | [infinite-water-curve-prototype.md](./infinite-water-curve-prototype.md) |
