...
| Benchmark | Reproducible hot-path regression thresholds, including v2 32x32 semantic generation, a 16-region working set backed by one 2048x2048 finite-dependency drainage basin, and derived hydrology rasterization | `scripts/benchmark-hot-paths.mjs` |
