...
想直接玩游戏，打开 [**余烬航线**](http://127.0.0.1:3000/emberwake.html)，
也可以点击演示页面的同名入口。驾驶飞艇穿越无限世界，点亮三座信标、选择改装，
在风暴来临前返回母港；每个行动都会自动保存。完整规则与实现对应关系见
