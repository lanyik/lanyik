...
| 世界风格 | generator v9 将确定性曲线带采样为跨区块的 `sea`/`coastal` 六边格地形 |
...
- 自动生成的六边格水网、手工河道 modifier、湖泊、海岸、连续山体、地表纹理去重复、大气天空、城市、单位和战争迷雾。
...
<http://127.0.0.1:3000/infinite-water.html>；其中的曲线几何与 generator v9
...
- [世界风格生成 v1](docs/world-style-generation-v1.md) 保留 generator v6 冻结基线，并记录 generator v9 曲线带六边格水体采样扩展。
