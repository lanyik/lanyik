...
| 世界风格 | generator v10 将多格宽水带与镂刻广域海盆采样为跨区块的 `sea`/`coastal` 地形 |
...
- 自动生成的多格宽六边格水网与镂刻海域、手工河道 modifier、湖泊、海岸、连续山体、地表纹理去重复、大气天空、城市、单位和战争迷雾。
...
<http://127.0.0.1:3000/infinite-water.html>；其中的曲线和海盆几何与 generator v10
...
- [世界风格生成 v1](docs/world-style-generation-v1.md) 保留 generator v6 冻结基线，并记录 generator v10 多格宽水网与镂刻海域扩展。
